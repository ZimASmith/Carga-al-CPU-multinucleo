...
#include<process.h> //biblioteca para la funcion _beginthreas
#include<time.h> //biblioteca para funciones de reloj
...
int main( int, char**)
{
	...
	//puedes jugar con los valores altos como 10 o 20 y veras que tu equipo ocupa el 100%
    int nucleos = 120;
    //se realiza el separado por hilos de ejecucion por nnumero de nucleos
...
void task1 (void *)
{
	...
	while (1)
	{
		...
		while(clock() < wakeup) {}
		//despues de 50 ticks, dormimos 50 milisegundos para darle respiro
